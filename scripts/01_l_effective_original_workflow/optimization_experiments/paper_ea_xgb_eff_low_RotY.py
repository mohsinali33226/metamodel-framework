...
class PaperXGBProblem(ElementwiseProblem):
    def __init__(self):
        # Paper Table 6 XGBoost hyperparameters:
        # max_depth: 20â€“200
        # n_estimators: 100â€“1500
        # learning_rate: 0.0001â€“0.1
        # L1 regularization: 0.0001â€“0.9
        # L2 regularization: 0.0001â€“0.9
        # minimum loss reduction / gamma: 0.00001â€“2.0
        super().__init__(
            n_var=6,
            n_obj=1,
            xl=np.array([20, 100, 0.0001, 0.0001, 0.0001, 0.00001]),
            xu=np.array([200, 1500, 0.1, 0.9, 0.9, 2.0]),
        )
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        reg_alpha = float(x[3])      # L1
        reg_lambda = float(x[4])     # L2
        gamma = float(x[5])          # minimum loss reduction
...
print("\nPaper-style EA-XGBoost optimization result")
print("TARGET =", TARGET)
...
print("PAPER_EA_XGB_TEST_R2 =", test_r2)
print("PAPER_EA_XGB_TEST_MAE =", test_mae)
print("IMPROVED =", test_r2 > CURRENT_BEST)

out = "./data/outputs/l_effective/paper_ea_xgb_eff_low_RotY_result.csv"
pd.DataFrame([{
    "target": TARGET,
    "method": "paper_style_EA_XGBoost",
